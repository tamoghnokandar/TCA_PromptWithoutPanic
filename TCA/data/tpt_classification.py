...
def test_time_tuning(model, inputs, optimizer, scaler, args):
    ...
    for j in range(args.tta_steps):
        ...
        if 'ctpt' in args.run_type:
           ...
           # (Ten) Imagenet ensemble 2 attributes Resnet GPU=6,7
     
           # (Fourth) Imagenet ensemble 2 attributes VITB-16 GPU=2,3
           ...
           # bash scripts/test_tpt_ctpt_ds.sh R
            ...
            # (Eight) Imagenet V2 ensemble 3 attributes VITB-16 GPU=1,0,4
            # (Nine) Imagenet Sketch ensemble 3 attributes VITB-16 GPU=5,6,7
