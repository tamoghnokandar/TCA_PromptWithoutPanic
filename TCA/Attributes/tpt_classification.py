...
def main_worker(gpu, args, result_dict):
    ...
    "V2" : "Attributes/ImageNet_2_V.json", 
...
if __name__ == '__main__':
    ...
    parser.add_argument('json_file', metavar='DIR', help='path to json file')
    parser.add_argument('--multi_gpu', type=bool, default=False, help='Use Multi GPU setting or not')
